...
public class WordBreak {
	...
	public static boolean canBreak(String word, Set<String> dict) {
		if (dict.isEmpty())
			return false;
	...
	public static void main(String[] args) {
		Set<String> wordSet = new HashSet<>(Arrays.asList(new String[] { "leet", "code" }));
		System.out.println(canBreak("leetcode", wordSet));
	}
}
