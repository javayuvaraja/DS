...
import com.yuva.leetcode.linkedlist.DLLNode;
...
public class BrowserHistory {
	...
	DLLNode<String> home = null;
	DLLNode<String> curr = null;
	
	public BrowserHistory(String homepage) {
		home = new DLLNode<>(homepage);
		curr = home;
    }
    ...
    public void visit(String url) {
    	...
    	DLLNode<String> newNode = new DLLNode<>(url);
    	newNode.prev = curr;
    	curr.next = newNode;
    	curr = curr.next;
    }
