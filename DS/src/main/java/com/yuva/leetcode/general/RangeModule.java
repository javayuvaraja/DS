...
public class RangeModule {
	...
	public void addRange(int left, int right) {
		...
		// current left is overlapping with prev start key
		...
		intervals.subMap(left, false, right, true).clear(); // removing the sub map which is between from left+1 to right
	}
