...
public class SnakeAndLadderGameService {
    ...
    public SnakeAndLadderGameService(int boardSize) {
        ...
        this.noOfDices = SnakeAndLadderGameService.DEFAULT_NO_OF_DICES;
    }
    ...
    private int getNewPositionAfterGoingThroughSnakesAndLadders(int newPosition) {
        ...
        do {
            ...
            if (snakeAndLadderBoard.getSnakes().containsKey(newPosition)) {
            	newPosition = snakeAndLadderBoard.getSnakes().get(newPosition).getEnd(); // Whenever a piece ends up at a position with the head of the snake, the piece should go down to the position of the tail of that snake.
            }
            
            if (snakeAndLadderBoard.getLadders().containsKey(newPosition)) {
            	newPosition = snakeAndLadderBoard.getLadders().get(newPosition).getEnd(); // Whenever a piece ends up at a position with the head of the snake, the piece should go down to the position of the tail of that snake.
            }
